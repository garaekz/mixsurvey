...
export default function SideNavComponent() {
  ...
  return (
    <aside
      id="logo-sidebar"
      className="fixed top-0 left-0 z-30 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-20 transition-transform dark:border-gray-700 dark:bg-gray-800 sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className="h-full overflow-y-auto bg-white px-3 pb-4 dark:bg-gray-800">
        <ul className="space-y-2">
          {routes.map((route) => (
            <li key={route.name}>
              <Link to={route.href} className="flex items-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                {route.icon}
